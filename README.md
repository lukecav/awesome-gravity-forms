...
* [Postmatic for Gravity Forms](https://gist.github.com/willmot/4155391) - This simple plugin allows individuals to subscribe to Postmatic feeds using Gravity Forms.
* [Gravity Forms Encryptorator](https://wordpress.org/plugins/postmatic-for-gravity-forms/) - Encrypt all Gravity Forms data on the way into the database using openssl public encryption, data can only be decrypted with the associated private key.
...
* [Gravity Forms Advanced File Uploader](https://wordpress.org/plugins/gravity-forms-advanced-file-uploader/) - This is the Gravity Forms uploader plugin for those who need a little more than the default multi file upload of Gravity Forms v1.8.
