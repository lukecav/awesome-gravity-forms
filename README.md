...
- [Notification Review for Gravity Forms](https://wordpress.org/plugins/notification-review-for-gravity-forms/) - Adds a "Notification Review" submenu item under Forms to display a table of all Gravity Forms notifications with Send To, From Name, From Email, Reply To, BCC, and Subject, with filtering by form status, form title, and search by email or subject.
